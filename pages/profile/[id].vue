    ...
    <div class="pt-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto">
      <div class="flex w-[calc(100vw-230px)]">
        ...
        <div class="ml-5 w-full">
          ...
          <div class="text-lg truncate">Username</div>
          ...
          <button v-else class="flex items-center rounded-md py-1.5 px-3.5 mt-3 text-[15px] text-white font-semibold bg-[#F02C56]">
            Follow
          </button>
        </div>
      </div>
