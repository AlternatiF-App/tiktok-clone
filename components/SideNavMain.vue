<template>
  ...
  >
    <div class="lg:w-full w-[55px] mx-auto">
      <nuxt-link to="/">
        <menu-item iconString="For You" colorString="#F02C56" sizeString="30"/>
      </nuxt-link>
      <menu-item iconString="Following" colorString="#000000" sizeString="27"/>
      <menu-item iconString="LIVE" colorString="#000000" sizeString="27"/>
